...
```
::error line=11,col=41,file=app/index.md::[vale] reported by reviewdog 🐶%0A[kong.Spelling] Did you really mean 'boobarbaz'?%0A%0ARaw Output:%0A{"message": "[demo.Spelling] Did you really mean 'boobarbaz'?", "location": {"path": "app/index.md", "range": {"start": {"line": 11, "column": 41}}}, "severity": "ERROR"}
```
...
| **`github-pr-annotation`**   | OK      | OK             | OK                      | OK |
